...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animation4 = ObjectAnimator.ofFloat(target,"alpha",1f,0.5f);
        animation4.setRepeatCount(ObjectAnimator.INFINITE);
        animation4.setRepeatMode(ObjectAnimator.REVERSE);

        // TODO ex2-3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1,animator2,animator3,animation4);
        animatorSet.start();
    }
}
